...
const cn = {
  ...
  Error: {
    Unauthorized:
      "访问密码不正确或为空，请前往设置页输入正确的访问密码，或者填入你自己的 OpenAI API Key。",
  },
  ChatItem: {
    ChatItemCount: (count: number) => `${count} 条对话`,
  },
  Chat: {
    SubTitle: (count: number) => `与 ChatBot 的 ${count} 条对话`,
    Actions: {
      ChatList: "查看消息列表",
  ...
  Export: {
    ...
    MessageFromChatGPT: "来自 ChatBot 的消息",
    Format: {
      Title: "导出格式",
